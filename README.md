...
| CDI | qemu patched |  :heavy_check_mark: Yes | My custom [qemu](https://github.com/foxdrodd/qemu) boots, [Wiki](https://github.com/foxdrodd/dreamcast-linux/wiki/QEMU-Support-for-Dreamcast) |
